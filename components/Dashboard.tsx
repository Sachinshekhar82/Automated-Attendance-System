    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-slate-500 font-medium">Avg Attendance (Weekly)</p>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            <p className="text-sm text-slate-500 font-medium">Low Attendance Alert</p>
            <h3 className="text-2xl font-bold text-slate-900">3</h3>
            <span className="text-xs text-slate-400">students below 75%</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-6 rounded-2xl text-white">
            ...
            <p className="text-blue-100 mb-4 text-sm">Generate monthly attendance reports for the education department automatically.</p>
